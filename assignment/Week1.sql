SET search_path TO salesorderexample;
...
select
	empfirstname,
	emplastname,
	to_char(empbirthdate, 'YYYY') as birth_year
from
	employees e
where
	employeeid = 705
...
select
	custfirstname || ', ' || custlastname as full_name
from
	customers c
...
from
	orders o
where
	orderdate between '2017-09-02' and '2017-09-03'
